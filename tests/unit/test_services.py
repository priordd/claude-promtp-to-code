...
from payment_service.models.payment import PaymentStatus, RefundStatus
...
class TestPaymentService:
    ...
    @pytest.fixture
    def payment_service(self, mock_banking_service, mock_event_service, 
                       mock_encryption_service, mock_cache_service):
    ...
    async def test_create_transaction(self, mock_db, payment_service, sample_payment_request, correlation_id):
...
class TestBankingService:
    ...
    async def test_authorize_payment_success(self, mock_client, banking_service, sample_card_data, correlation_id):
    ...
    @pytest.mark.asyncio
    @patch('payment_service.services.banking_service.httpx.AsyncClient')
    async def test_authorize_payment_declined(self, mock_client, banking_service, sample_card_data, correlation_id):
