...
class RefundProcessingError(PaymentServiceException):
    ...
    def __init__(self, message: str, refund_id: Optional[str] = None, transaction_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
...
class RateLimitError(PaymentServiceException):
    ...
    def __init__(self, message: str = "Rate limit exceeded", limit: Optional[int] = None, window: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
...
class InvalidTransactionStateError(PaymentServiceException):
    ...
    def __init__(self, transaction_id: str, current_state: str, required_state: str, details: Optional[Dict[str, Any]] = None):
