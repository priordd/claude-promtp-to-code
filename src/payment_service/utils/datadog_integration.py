...
class DatadogIntegration:
    ...
    def _setup_datadog(self) -> None:
        ...
        try:
            ...
            ddtrace.config.postgres["service_name"] = f"{settings.dd_service}-postgres"
            ddtrace.config.kafka["service_name"] = f"{settings.dd_service}-kafka"
    ...
    def create_span(self, operation_name: str, service: Optional[str] = None, resource: Optional[str] = None):
    ...
    def log_event(self, title: str, text: str, alert_type: str = "info", tags: Optional[Dict[str, str]] = None) -> None:
    ...
    def create_custom_metrics(self) -> None:
        ...
        self.gauge("payment.database.pool.size", settings.database_pool_size, tags={"service": settings.dd_service})
        
        # Cache metrics
        self.gauge("payment.cache.max_size", settings.cache_max_size, tags={"service": settings.dd_service})
    
    def record_payment_metrics(self, status: str, amount: float, currency: str, merchant_id: str) -> None:
    ...
    def record_api_metrics(self, endpoint: str, method: str, status_code: int, duration: float) -> None:
    ...
    def record_database_metrics(self, operation: str, table: str, duration: float, success: bool) -> None:
